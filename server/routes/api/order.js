...
router.post('/add', auth, async (req, res) => {
  try {
    ...
    //  Populate user so we can get their email
    ...
    const newOrder = {
      ...
      created: populatedOrder.created,
      user: populatedOrder.user,
      total: populatedOrder.total,
      products: cartDoc.products
    };

const { sendOrderEmail } = require('../../services/mail');

await sendOrderEmail(populatedOrder.user.email, newOrder);
